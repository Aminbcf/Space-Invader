...
typedef struct {
  ...
  void (*draw_rect)(void *view, int x, int y, int w, int h, uint8_t r,
                    uint8_t g, uint8_t b, uint8_t a);
  void (*draw_text)(void *view, const char *text, int x, int y, uint8_t r,
                    uint8_t g, uint8_t b);
...
typedef enum { VIEW_TYPE_SDL, VIEW_TYPE_NCURSES, VIEW_TYPE_NONE } ViewType;
